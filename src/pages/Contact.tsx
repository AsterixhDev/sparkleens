...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Message Sent",
      description:
        "Thanks — we'll get back to you within 24 hours. For quote requests, tap Request Quote.",
    });
      ...
      <section className="relative py-24 overflow-hidden bg-section-light">
        ...
        <div className="container relative mx-auto px-4 text-center flex flex-col items-center justify-center gap-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Ready To Get <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Started?</span>
          </h1>
              ...
              <div className="p-6 rounded-2xl border border-primary bg-primary/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+14702271318" className="block text-foreground mt-1">
                      (470) 227-1318
                    </a>
                  </div>
                </div>
              ...
              <div className="p-6 rounded-2xl border border-primary bg-primary/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:broomeservicesolutions@gmail.com" className="block text-foreground mt-1 break-all">
              ...
              <div className="p-6 rounded-2xl border border-accent bg-accent/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground mt-1 font-semibold">Mon–Sat: 8 AM – 7 PM</p>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button type="submit" className="bg-primary hover:bg-primary-hover text-primary-foreground rounded-full">
                    Send Message
                  </Button>
                  <Button
                    type="button"
